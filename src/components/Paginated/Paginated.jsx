      ...
      <div className="flex items-center gap-x-5 justify-center">
        ...
        {data.map((counter, index) => (
          <li
            ...
            className={`flex font-inter bg-button items-center justify-center h-10 w-10 transition-all ease-in-out duration-100 relative rounded-full p-4 ${selectedNumber === counter ? 'bg-white text-rich-black font-bold' : ''}`}
          >
